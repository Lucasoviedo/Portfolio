    ...
    <section id='stack' className={`section-container ${!fire && "section-container-dark"}`}>
      <div className='container'>
        ...
        <div className={`stack-list-container ${!fire && "stack-list-container-dark"}`}>
          <StackItem image={bootstrapLogo} name="Bootstrap" link="https://getbootstrap.com/"/>
          <StackItem image={cssLogo} name="CSS" link="https://developer.mozilla.org/es/docs/Web/CSS"/>
          <StackItem image={htmlLogo} name="HTML" link="https://html.com/"/>
          <StackItem image={javascriptLogo} name="JavaScript" link="https://www.javascript.com/"/>
          <StackItem image={reactLogo} name="React" link="https://reactjs.org/"/>
          <StackItem image={reactRouterLogo} name="React Router" link="https://reactrouter.com/en/main"/>
          <StackItem image={reduxLogo} name="Redux" link="https://es.redux.js.org/"/>
        </div>
        <h3 className={`stack-list-title ${!fire && "stack-list-title-dark"}`}>Back-end</h3>
        <div className={`stack-list-container ${!fire && "stack-list-container-dark"}`}>
          <StackItem image={cppLogo} name="C++" link="https://isocpp.org/"/>
          <StackItem image={javascriptLogo} name="JavaScript" link="https://www.javascript.com/"/>
          <StackItem image={mysqlLogo} name="MySQL" link="https://www.mysql.com/"/>
          <StackItem image={pythonLogo} name="Python" link="https://www.python.org/"/>
          <StackItem image={sqlserverLogo} name="SqlServer" link="https://www.microsoft.com/es-es/sql-server/sql-server-downloads"/>
        </div>
        <h3 className={`stack-list-title ${!fire && "stack-list-title-dark"}`}>{texts.stack.others}</h3>
        <div className={`stack-list-container ${!fire && "stack-list-container-dark"}`}>
          <StackItem image={dockerLogo} name="Docker" link="https://www.docker.com/"/>
          <StackItem image={githubLogo} name="GitHub" link="https://github.com/"/>
          <StackItem image={jiraLogo} name="Jira" link="https://www.atlassian.com/es/software/jira"/>
        </div>  
      </div>
    </section>
  )
